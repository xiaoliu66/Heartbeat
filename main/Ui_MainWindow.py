...
class Ui_MainWindow(object):
    ...
    def setupUi(self, MainWindow):
        ...
        MainWindow.resize(748, 515)
        self.centralwidget = QtWidgets.QWidget(MainWindow)
        self.centralwidget.setObjectName("centralwidget")

        self.lcdNumber = QtWidgets.QLCDNumber(self.centralwidget)
        self.lcdNumber.setGeometry(QtCore.QRect(230, 50, 291, 201))
        self.lcdNumber.setObjectName("lcdNumber")
        self.lcdNumber.setDigitCount(3) # 设置QLCDNumber对象设置为12位

        self.pushButton = QtWidgets.QPushButton(self.centralwidget)
        self.pushButton.setGeometry(QtCore.QRect(310, 350, 121, 31))
        self.pushButton.setStyleSheet("font: 9pt \"Cascadia Mono\";")
        self.pushButton.setObjectName("pushButton")
        self.pushButton.clicked.connect(self.clickButton) #绑定点击事件
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.pushButton.setText(_translate("MainWindow", "start Connet"))
